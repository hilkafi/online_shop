...
<?php 
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        $upslider = $ct->updateSlider($_POST, $sid);
    }
 ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <hr>
                                <?php if (isset($upslider)) {
                                    echo $upslider;
                                } ?>

                                <?php $getSlider = $ct->getSliderById($sid);
                                    if ($getSlider) {
                                ...
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="text-input" name="subtitle" value="<?php echo $result['subtitle']; ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <img src="<?php echo $result['image']; ?>" width=200>
